/* LCD-TFT Code for GPS Project for Embedded System 
 *  Created by Abdo Shakwy 13/5/2025 
 *  the connection 
 *      Tefa-c              Arduino
 *    Uart3 (pin 7)   To    RX
 *      GND           To    GND
...
void setup() 
{
   ...
   {
    // the pictures name in the sd-card
   strcpy(file_name[0], "Old1.bmp");
    strcpy(file_name[1], "Library1.bmp");
    strcpy(file_name[2], "FB1.bmp");
    strcpy(file_name[3], "Mosque1.bmp");
    strcpy(file_name[4], "Credit1.bmp");
    strcpy(file_name[5], "HallC1.bmp");
    strcpy(file_name[6], "Old1.bmp");
    strcpy(file_name[7], "HallA1.bmp");
    strcpy(file_name[8], "logo.bmp");
   }
  ...
  //Init SD_Card
   pinMode(10, OUTPUT);
    ...
    TFTShow(8); // default picture to display is the logo 
}

void loop() 
{
  if (Serial.available()) {      // if number was sent display its crosponding pic. the numbers from 0 to 7  
